...
export async function summarizeStudyPage(
  ...
  const lengthInstruction =
    summaryLength === "short"
      ? "Be concise — max 5 key concepts, a 2-3 sentence summary, max 5 action items."
      : "Be thorough — up to 10 key concepts, a detailed multi-paragraph summary, and all action items.";

  const systemPrompt = `You are an expert study assistant and educational content analyst. Analyze the provided text from a book or study material and return a structured JSON summary.
