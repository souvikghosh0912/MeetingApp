      ...
      <div className="max-w-5xl mx-auto">
        {!compact && (
          <div className="text-center mb-16">
            ...
            <p className="text-text-secondary text-lg max-w-md mx-auto mb-8">
              Start free. Upgrade when Mnemis earns its keep — most teams see ROI in the first week.
            </p>
        ...
        <div className="rounded-2xl border border-white/[0.07] bg-white/[0.02] p-8 mb-16 text-center">
          <p className="text-xl font-semibold text-white mb-2">
            The average Mnemis Pro user saves <span className="text-emerald-400">₹8,000/month</span> in tool costs.
          </p>
