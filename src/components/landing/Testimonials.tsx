const testimonials = [
  {
    quote:
      "We replaced Otter, Notion AI, and our old ATS with Mnemis. The hiring workflow alone saves us 3 hours per candidate batch.",
    name: "Priya Sharma",
  ...
  {
    quote:
      "Meeting Intelligence pays for itself every Monday. Our team stopped writing meeting notes entirely — Mnemis handles it better than we ever did.",
    name: "Riya Verma",
