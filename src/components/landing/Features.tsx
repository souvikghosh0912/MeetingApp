...
const tools = [
  {
    ...
    description:
      "Drop any audio or video file. Mnemis transcribes with Whisper v3, then extracts TL;DRs, action items, key decisions, and sentiment — structured for your team.",
    icon: Mic,
  ...
  },
  {
    ...
    description:
      "Paste your job description. Upload a batch of resumes. Mnemis ranks every candidate against your criteria, highlights red flags, and drafts interview questions — instantly.",
    icon: FileSearch,
  ...
  },
  {
    ...
    description:
      "Just say what you want to automate. Mnemis generates multi-step workflows — with branches, conditions, and integrations — that you can deploy or modify with a click.",
    icon: GitBranch,
  ...
  },
  {
    ...
    description:
      "Mnemis reads your meetings, workflows, and docs — then automatically creates tasks, assigns them to owners, sets priorities, and tracks completion across your whole team.",
    icon: CheckSquare,
      ...
      <section className="py-24 px-6" id="tools">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-20">
            <p className="text-[11px] font-semibold text-text-muted uppercase tracking-widest mb-3">What&apos;s inside Mnemis</p>
