...
export async function POST(request: NextRequest) {
  try {
    ...
    const { extractedText, model, title, sourceImagePath, customInstructions } = body;
    ...
    const summary = await summarizeStudyPage(extractedText, model, limits.summaryLength, customInstructions);
